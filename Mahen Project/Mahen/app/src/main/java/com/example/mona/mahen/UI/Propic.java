...
public class Propic extends AppCompatActivity {
    ...
    String name, un, email, pass, type, b_day, sex, ssn, pp,acttp,address,country,contact;
    User user;
    @Bind(R.id.pic)
    CircleImageView pic;
    @Bind(R.id.Upload)
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.reg:
                setUpUser();
                Intent in=new Intent(Propic.this,Front.class);
                startActivity(in);
                Toast.makeText(Propic.this,
